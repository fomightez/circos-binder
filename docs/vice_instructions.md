...
| <img class="tool-thumb" style="border-style: solid; border-width: 1px;" src="https://raw.githubusercontent.com/fomightez/circos-binder/master/docs/patmach_opening_directory.png" width="200" /> | When JupyterLab has launched, double-click the **index.ipynb** file. |
